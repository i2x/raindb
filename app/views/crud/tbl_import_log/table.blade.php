...
@if (Session::has('flash_message'))
	...
	<ol class="breadcrumb">
  	...
  	<li class="active">tbl_import_log</li>
	</ol>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('database/tbl_import_log/create') }}}" class="btn btn-small btn-info iframe">
...
@section('scripts')
	...
	<script type="text/javascript">
		...
		function Delete(id) {
			bootbox.confirm("<code>logid "+id+" </code>will be deleted immediately. Are you sure you want to continue?", 
			function(result) {
				if(result){
					 $.ajax( 
							 {
