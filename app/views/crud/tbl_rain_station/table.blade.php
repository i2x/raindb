	...
	<ol class="breadcrumb">
  	...
  	<li class="active">tbl_rain_station</li>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('database/tbl_rain_station/create') }}}" class="btn btn-small btn-info iframe">
...
@section('scripts')
	...
	<script type="text/javascript">
		...
		function Delete(id) {
			bootbox.confirm("<code>stationid "+id+" </code>will be deleted immediately. Are you sure you want to continue?", 
			function(result) {
				if(result){
					 $.ajax( 
							 {

							    url: 'tbl_rain_station/'+id+'/delete',
							    type: 'POST',
