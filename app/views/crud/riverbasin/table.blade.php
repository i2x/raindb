	...
	<ol class="breadcrumb">
  	...
  	<li class="active">riverbasin</li>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('database/riverbasin/create') }}}" class="btn btn-small btn-info iframe">
	 ...
	 <div class="page-header">
						...
						<thead>
								...
								<tr>
									...
									<th class="col-md-1">basin_name</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			oTable = $('#gridview').dataTable( {
		        ...
		        "bServerSide": true,
		        "iDisplayLength": 25,
		        "sAjaxSource": "{{ URL::to('database/riverbasin/data') }}",
		...
		function Delete(id) {
			bootbox.confirm("<code>basin_id "+id+" </code>will be deleted immediately. Are you sure you want to continue?", 
			function(result) {
				if(result){
					 $.ajax( 
							 {

							    url: 'riverbasin/'+id+'/delete',
							    type: 'POST',
