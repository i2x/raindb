...
@if (Session::has('flash_message'))
	...
	<ol class="breadcrumb">
  	...
  	<li class="active">permission_role</li>
	</ol>
	 ...
	 <div class="page-header">
						...
						<thead>
								...
								<tr>
									...
									<th class="col-md-1">permission_id</th>
									<th class="col-md-1">role_id</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			oTable = $('#gridview').dataTable( {
		        ...
		        "bServerSide": true,
		        "iDisplayLength": 25,
		        "sAjaxSource": "{{ URL::to('database/permission_role/data') }}",
		...
		function Delete(id) {
			bootbox.confirm("ID: "+id+" </code>will be deleted immediately. Are you sure you want to continue?", 
			function(result) {
				if(result){
					 $.ajax( 
							 {
