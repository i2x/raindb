	...
	<ol class="breadcrumb">
  	...
  	<li class="active">tbl_ampher</li>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('database/tbl_ampher/create') }}}" class="btn btn-small btn-info iframe">
...
@section('scripts')
	...
	<script type="text/javascript">
		...
		function Delete(id) {
			bootbox.confirm("<code>ampher_id "+id+" </code>will be deleted immediately. Are you sure you want to continue?", 
			function(result) {
				if(result){
					 $.ajax( 
							 {

							    url: 'tbl_ampher/'+id+'/delete',
							    type: 'POST',
