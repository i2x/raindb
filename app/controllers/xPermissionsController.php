...
class xPermissionsController extends AdminController {
...
//GET 
	...
	public function getData()
	{
		...
		$groups = DB::table('permissions')->select(array('permissions.id',
...
// INDEX
	public function index()
	{
		...
		return View::make('crud.permissions.table');
	}
...
//EDIT
	...
	public function getUpdate($post)
	{
		...
		->with('data',$ampher)
		->with('title',' <span class="glyphicon glyphicon-edit"></span>permissions')
