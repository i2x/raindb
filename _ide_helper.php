...
namespace {
    ...
    class Datatables extends \Bllim\Datatables\Facade\Datatables{
         ...
         * @static 
         */
        public static function set_row_class($content){
            return \Bllim\Datatables\Datatables::set_row_class($content);
        }
         ...
         * @static 
         */
        public static function set_row_data($name, $content){
            return \Bllim\Datatables\Datatables::set_row_data($name, $content);
        }
