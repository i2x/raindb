...
namespace {
    ...
    class Excel extends \Maatwebsite\Excel\Facades\Excel{
		 ...
		 * Construct Excel
		 *
		 * @param \Maatwebsite\Excel\PHPExcel $excel
		 * @param \Maatwebsite\Excel\LaravelExcelReader $reader
		 * @param \Maatwebsite\Excel\LaravelExcelWriter $writer
		 * @static 
		 */
    ...
    class Datatables extends \Bllim\Datatables\Facade\Datatables{
        ...
        public static function __construct(){
            \Bllim\Datatables\Datatables::__construct();
        }
		 ...
		 * @static 
		 */
        public static function add_column($name, $content, $order = false){
            return \Bllim\Datatables\Datatables::add_column($name, $content, $order);
        }
		 ...
		 * @static 
		 */
        public static function edit_column($name, $content){
            return \Bllim\Datatables\Datatables::edit_column($name, $content);
        }
		 ...
		 * @static 
		 */
        public static function remove_column(){
            return \Bllim\Datatables\Datatables::remove_column();
        }
		 ...
		 * @static 
		 */
        public static function filter_column($column, $method){
            return \Bllim\Datatables\Datatables::filter_column($column, $method);
        }
		 ...
		 * @static 
		 */
        public static function set_index_column($name){
            return \Bllim\Datatables\Datatables::set_index_column($name);
        }
		 ...
		 * @static 
		 */
        public static function wildcard_like_string($str, $lowercase = true){
            return \Bllim\Datatables\Datatables::wildcard_like_string($str, $lowercase);
        }
        ...
        public static function __call($name, $arguments){
            return \Bllim\Datatables\Datatables::__call($name, $arguments);
        }
