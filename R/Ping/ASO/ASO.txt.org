...
# LOAD INDEX DATA
pred_index=c("SAT","SLP","SXW","SYW")	# predictors of seasonal rainfall
unit=c("C","mb","m/s","m/s")
...
mth=8			# starting month of season
...
{
if(v == 1)
{fpreds=cbind(fpreds1[,2],fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,2],gcm_fpreds1[,3])
name_p=paste(pred_index[2],"_",pred_index[3],sep="")}
if(v == 2)
{fpreds=cbind(fpreds1[,2],fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,2],gcm_fpreds1[,3])
name_p=paste(pred_index[2],"_",pred_index[3],sep="")}
if(v == 3)
{fpreds=cbind(fpreds1[,1],fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,3])
name_p=paste(pred_index[1],"_",pred_index[3],sep="")}
if(v == 4)
...
name_p=paste(pred_index[3],sep="")}
if(v == 6)
{fpreds=cbind(fpreds1[,2],fpreds1[,3],fpreds1[,4])
gcm_fpreds=cbind(gcm_fpreds1[,2],gcm_fpreds1[,3],gcm_fpreds1[,4])
name_p=paste(pred_index[2],"_",pred_index[3],"_",pred_index[4],sep="")}
if(v == 7)
{fpreds=cbind(fpreds1[,2],fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,2],gcm_fpreds1[,3])
name_p=paste(pred_index[2],"_",pred_index[3],sep="")}
...
if(v == 11)
{fpreds=cbind(fpreds1[,1],fpreds1[,2])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,2])
name_p=paste(pred_index[1],"_",pred_index[2],sep="")}
if(v == 12)
{fpreds=cbind(fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,3])
name_p=paste(pred_index[3],sep="")}
