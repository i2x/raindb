...
if(v == 3)
{fpreds=cbind(fpreds1[,1],fpreds1[,3],fpreds1[,4])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,3],gcm_fpreds1[,4])
name_p=paste(pred_index[1],"_",pred_index[3],"_",pred_index[4],sep="")}
if(v == 4)
{fpreds=cbind(fpreds1[,3])
gcm_fpreds=cbind(gcm_fpreds1[,3])
name_p=paste(pred_index[3],sep="")}
...
if(v == 6)
{fpreds=cbind(fpreds1[,3],fpreds1[,4])
gcm_fpreds=cbind(gcm_fpreds1[,3],gcm_fpreds1[,4])
name_p=paste(pred_index[3],"_",pred_index[4],sep="")}
if(v == 7)
...
gcm_fpreds=cbind(gcm_fpreds1[,4],gcm_fpreds1[,5])
...
limit=c(59.4,97.6)	# p30th and p70th of seasonal rainfall (change as needed)
