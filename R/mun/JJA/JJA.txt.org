...
mth=6			# starting month of season
mon=8			# ending month of season
...
name_p=paste(pred_index[3],sep="")}
if(v == 6)
{fpreds=cbind(fpreds1[,1],fpreds1[,2],fpreds1[,5])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,2],gcm_fpreds1[,5])
name_p=paste(pred_index[1],"_",pred_index[2],"_",pred_index[5],sep="")}
if(v == 7)
