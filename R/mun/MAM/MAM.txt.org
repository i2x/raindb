...
name_p=paste(pred_index[2],sep="")}
if(v == 5)
{fpreds=cbind(fpreds1[,1],fpreds1[,2],fpreds1[,4])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,2],gcm_fpreds1[,4])
name_p=paste(pred_index[1],"_",pred_index[2],"_",pred_index[4],sep="")}
if(v == 6)
