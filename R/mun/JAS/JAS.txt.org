...
mth=7			# starting month of season
mon=9			# ending month of season
...
name_p=paste(pred_index[1],sep="")}
if(v == 5)
{fpreds=cbind(fpreds1[,1],fpreds1[,4])
gcm_fpreds=cbind(gcm_fpreds1[,1],gcm_fpreds1[,4])
name_p=paste(pred_index[1],"_",pred_index[4],sep="")}
if(v == 6)
